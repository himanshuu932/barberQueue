...
const Barber = () => {
  ...
  const fetchBarbers = async (uid) => {
    try {
      const response = await fetch(`https://numbr-p7zc.onrender.com:5000:5000/barbers?shopId=${uid}`);
  ...
  const handleSaveEmployee = async () => {
    ...
    try {
      const response = await fetch("https://numbr-p7zc.onrender.com:5000:5000/barber/signup", {
        method: "POST",
  ...
  const handleUpdateBarber = async () => {
    ...
    try {
      const response = await fetch("https://numbr-p7zc.onrender.com:5000:5000/barber/profile", {
        method: "PATCH",
        headers: { "Content-Type": "application/json" },
